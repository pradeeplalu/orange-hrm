...
/* This is to verify text message on the element
 ...
 */
    ...
    public void verifyAssertText(WebElement element1,String message){
        String expectedmessage = message;
        String actualmessage = getTextFromElement(element1);
        Assert.assertEquals(actualmessage,expectedmessage,message + "  It is not display");
    }
    public void verifySoftAssertText(WebElement element1,String message){
        SoftAssert softAssertObject = new SoftAssert();
        String expectedmessage = message;
        String actualmessage = getTextFromElement(element1);
        softAssertObject.assertEquals(actualmessage,expectedmessage,message+ "  It is not display");
    }
}
